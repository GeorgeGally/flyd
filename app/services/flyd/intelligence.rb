  ...
  class Intelligence
    ...
    def system_prompt
      <<~PROMPT
        ...
        - discovery: judge which supplied evidence the user would genuinely find interesting, then create up to 12 ranked discovery_scene items. Curate rather than listing everything. Use terse titles (≤100 chars) and single-sentence summaries. Include a specific one-line metadata.why_it_matters grounded in the evidence.
