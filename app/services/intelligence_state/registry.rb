module IntelligenceState
  class Registry
    ...
    def initialize(providers: [ RuntimeTaskProvider.new, CliProvider.new, PersonalContextProvider.new, WebDiscoveryProvider.new, Last30DaysProvider.new, WeatherProvider.new, PosttractionProvider.new ], query_provider: CliQueryProvider.new)
      @providers = providers
