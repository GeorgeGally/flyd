...
export interface OpenOperationalDecisionFact {
...
export class OperationalDecisionStore {
  ...
  async listOpenDecisionFacts(): Promise<OpenOperationalDecisionFact[]> {
    const decisions = await this.listOpenDecisions();
